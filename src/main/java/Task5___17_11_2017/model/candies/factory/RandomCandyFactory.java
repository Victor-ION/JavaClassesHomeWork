...
public class RandomCandyFactory extends AbstractCandyFactory {
    ...
    public Candy getElement(int typeNumber) {
        ...
        switch (typeNumber){
            case 1: return new Candy(map);
            case 2: return new CoronaMilkChoc(map);
            case 3: return new HappyCake(map);
            case 4: return new JellyBelly(map);
            case 5: return new NutParadise(map);
            case 6: return new RoshChoc(map);
            case 7: return new RoshChocMilk(map);
            case 8: return new WomboCombo(map);
            case 9: return new WomboComboExtraChoc(map);
        }
        return null;
    }
}
